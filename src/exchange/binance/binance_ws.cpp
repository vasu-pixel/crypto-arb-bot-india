...
BinanceWs::BinanceWs(const std::string& ws_base_url, ExchangeWsClient& ws_client)
...
void BinanceWs::subscribe_depth(const std::string& symbol, OrderBookCallback callback) {
    ...
    // Subscribe via combined stream: {symbol}@depth@100ms
